...
inference(y=response,x=as.factor(year),data=sp,statistic = "proportion", type = "ht", method = "theoretical", success = "atheist",null = 0, alternative = "twosided",conf_level = 0.95)
```
